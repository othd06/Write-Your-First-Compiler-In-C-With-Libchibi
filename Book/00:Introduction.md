...
I would also recommend that you be at least fairly familiar with C. You needn't be some sort of C god, indeed it isn't even my own preferred language, that title belongs to [Nim](https://nim-lang.org/) (although typically configured to be semantically very C-like), but compilers, even when they're made easy, certainly aren't a style of project that are well suited to people who have never touched a line of systems-level code before.
